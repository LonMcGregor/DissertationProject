    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coursework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.Coursework')),
                ('feedback', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='test_result_feedback_file_relation', to='student.File')),
                ('results', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='test_result_results_file_relation', to='student.File')),
