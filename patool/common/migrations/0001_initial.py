# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-05-23 16:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=common.models.upload_directory_path)),
            ],
        ),
        migrations.CreateModel(
            name='Submission',
        ...
        migrations.AddField(
            model_name='file',
            name='submission',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='common.Submission'),
        ),
