...
These are the objectives that relate to the Prototyping of the peer testing website. These are further broken down into requirements in the next section on implementation (Chapter \ref{ch:proto1}).
...
An ideal implementation of this would provide a way for testers to give feedback to the developers. Possible objectives that could interact with feedback include:
\begin{itemize}
...
After the 2nd iteration of development, the website was in a state that it was ready to be evaluated by real people. This chapter will detail the system design, as it was in this state.
\section{User Interface Design}
...
\subsection{Initial Storyboards}
This section will show some of the initial storyboarding ideas for how to lay out the important views of the website.\\
\scriptsize
\makebox[\textwidth][c]{
\begin{tabular}{cc}
\includegraphics[page=3, width=0.65\textwidth]{storyboard/storyboard2.pdf} & 
\includegraphics[page=4, width=0.65\textwidth]{storyboard/storyboard2.pdf} \\
SB1 - This is a mock-up of the website login page &
SB2 - This is a mock-up of the coursework listing page,\\ & detailing the various coursework tasks a user has access to.
\end{tabular}
}
\makebox[\textwidth][c]{
\begin{tabular}{cc}
\includegraphics[page=5, width=0.65\textwidth]{storyboard/storyboard2.pdf} & 
\includegraphics[page=6, width=0.65\textwidth]{storyboard/storyboard2.pdf} \\
SB3 - This is a mock-up of the coursework descriptor page, &
SB4 - This is a mock-up of the upload page,\\
showing the various tasks that are to be completed & where a user will upload solutions and test cases
\end{tabular}
}
\makebox[\textwidth][c]{
\begin{tabular}{cc}
...
SB5 - This is a mock-up of the feedback view, &
SB6 - This is a mock-up of a page informing the user,\\
...
SB7 - This is a mock-up of the teacher overview, &
SB8 - This is an improved view of the coursework descriptor page,\\
showing the all of the data and uploads for courseworks & showing the greater level of detail explaining the task
\end{tabular}
}
\normalsize

The mock-ups SB1 through SB7 were created during the 1st iteration of development. They were created to show a general sense of what would be required for the websites base functionality, and to guide the development of the views of the application. Mockup SB8 was created during the 2nd iteration of development, as I needed to improve upon the coursework descriptor page, and having a mock-up would help decide what detail could be included without overcrowding it.\par
\todo{Do we really need such things as the login page? And do we want to have screenshots of the final implementation?}

\section{System Architecture}
The bloody system architecture. Alright. Lets just get this fucking done.
\subsection{Initial Architecture Plan}
...
\subsection{2nd Iteration Architecture}
...
\subsubsection{MVC}
...
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{fig/seq.png}
\label{fig:seqd}
