...
\todo{Remember to fix all instances of ``peer asessment'' with ``peer testing''}
...
The purpose of these meetings was to further refine what might be required for a full implementation of the website. These were quite insightful, and I have developed the following \todo{notes? changes? requirements?} as a result:
...
\chapter{Glossaryck, of terms}
\todo{this is a fun joke, but change it to a proper title / position l8r}\\
...
\gloss{Peer Assessment}{The process of marking or grading an assignment where the students mark each others work (in whole or in part)}
\gloss{Peer-Testing}{When students test each others programming code}
\gloss{Solution}{A students solution to a coursework assignment}
