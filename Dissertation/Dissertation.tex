...
\item Flask (Python)
\end{itemize}
Of these, \todo{something something something} so I chose to develop the website using Django. Models? cms? auth management? clean language? unclean language? lightweight? better support? uni compatibility a factor?
