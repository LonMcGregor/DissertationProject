...
% BEGIN
\includepdf[pages={1}]{eva/consent.pdf}
\includepdf[pages={2}]{eva/consent.pdf}


\newpage
\addcontentsline{toc}{section}{C: Evaluation Survey Form}
\includepdf[pages={1}]{eva/survey.pdf}
\includepdf[pages={2}]{eva/survey.pdf}
\includepdf[pages={3}]{eva/survey.pdf}
\includepdf[pages={4}]{eva/survey.pdf}
\includepdf[pages={5}]{eva/survey.pdf}
\includepdf[pages={6}]{eva/survey.pdf}
\includepdf[pages={7}]{eva/survey.pdf}
\includepdf[pages={8}]{eva/survey.pdf}
\includepdf[pages={9}]{eva/survey.pdf}
% END
