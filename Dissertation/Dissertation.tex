...
\begin{figure}
\centering
\includegraphics[page=4, width=0.7\textwidth]{storyboard/storyboard2.pdf}
...
\begin{figure}
\centering
\includegraphics[page=5, width=0.7\textwidth]{storyboard/storyboard2.pdf}
...
\begin{figure}
\centering
\includegraphics[page=7, width=0.7\textwidth]{storyboard/storyboard2.pdf}
...
\begin{figure}
\centering
\includegraphics[page=8, width=0.7\textwidth]{storyboard/storyboard2.pdf}
...
\begin{figure}
\centering
\includegraphics[page=9, width=0.7\textwidth]{storyboard/storyboard2.pdf}
\caption{\label{fig:sb5}This is a mock-up of the teacher overview, showing the all of the data and uploads for courseworks}
\end{figure}
\begin{figure}
\centering
\includegraphics[page=10, width=0.7\textwidth]{storyboard/storyboard2.pdf}
