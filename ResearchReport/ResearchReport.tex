...
\appendix
\section{Glossary}
\gi{Solution}{The solution program/script to a set coursework assignment}
\gi{Student}{The person who will complete a coursework assignment}
\gi{Teacher}{The person in charge of a course who will create and set the coursework assignment}
\gi{Lecturer}{See Teacher} %TODO make these consistent
