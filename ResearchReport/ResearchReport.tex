...
djdu8 rldjq yhdoyhorywa8hfhfo3q h hf hfdh8f sjfoa ;oaj d
...
\subsection{Similar study}\todo{get rid of this subsection title}
...
\subsection{Summary of code test}
 ;kf jfpi jfp fjpjfpifjw a;wjf;ksl jfw0u jfj;if ajsljsl. \todo{ this seems quite a short section}
...
\subsection{Summary of Tech-Enahcned platforms}
 jfjwpj apfapmskdfuj80w jflsmf dsas o \todo{break this sectoin up more to subsections}
...
\todo{currently the bibifi part focus more on impl than contest. mention that too, or separate}
...
\subsection{Summary}
jlajlkdasj;a jfifp f'f k-2fj3pi \todo{why is a contest like environemtn desirable}
