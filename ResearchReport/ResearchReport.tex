...
\objitem{Upload}{File upload for solutions}{High Priority}{The website will let students upload solutions to assignments. This first prototype will focus specifically on python scripts}
\objitem{Test}{Build test cases}{Medium Priority}{The website will let students build test cases in a simple way. Possible implementations of this include:
\begin{itemize}
